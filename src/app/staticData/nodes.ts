		...
		verbatin: [
			{
				id: "",
				shortText: `<div>
					Na <a>Matriz do Bação</a> há duas pias de batismo próximas à sacristia, no <a>Livro de Tombos</a> a autoria de uma das pias é atribuída a <a>José Victor</a>. Por conta da semelhança entre as duas pias, acredito que ambas tenham sido feitas pelo polímata.
				</div>`,
		...
		verbatin: [
			{
				id: "",
				shortText: `<div>
					Freguesia era uma denominação utilizada pela <a>Igreja Católica</a> para determinar as áreas de influências da paróquia, determinando um município. A mudança de freguesia do <a>Bação</a> foi quando a paróquia deixou de ser filial da paróquia de <a>Itabira do Campo</a>, em 1883. 
				</div>`,
				longText: `-TODO algo`
			}
		]
		...
		verbatin: [
			{
				id: "",
				shortText: `<div>
					Dr. Senna foi um prefeito de <a>Vila Rica</a> na época de <a>José Victor</a>, ele tinha grande interesse nos trabalhos do polímata, chegando até a oferecer uma <a>bolsa</a> para que o inventor continuasse com seus trabalhos.
				</div>`,
		...
		verbatin: [
			{
				id: "",
				shortText: `<div>
					Após a <a>mudança de freguesia</a>, o fluxo de pessoas que ia para o <a>Bação</a> aumentou e isso acarretou no aumento na quantidade de comércios no distrito, principalmente na R. da Pimenta.  Na Rua da Pimenta haviam cerca de 20 pontos de comércios, os comerciantes buscavam mercadorias do <a>Rio de Janeiro</a> pela <a>Estrada de Ferro Central do Brasil</a> e levavam para o <a>Bação</a> mercadorias difíceis de serem achada na região na época, como vinho do porto e seda.   
				</div>`,
				longText: `
					No vídeo, <a>Marilene</a> conta sobre uma pesquisa que a realizou com <a>D. Divina</a>, filha de um dos comerciantes da R. da Pimenta, <a>Sr. Benjamin</a>, sobre os tipos de mercadoria que estava chegando ao <a>Bação</a> nessa época. (-TODO colocar vídeo e verificar nome)
				`
			}
		]
	},
