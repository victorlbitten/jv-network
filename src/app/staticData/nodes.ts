export const nodes = [
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Na <a>Matriz do Bação</a> há duas pias de batismo próximas à sacristia, no <a>Livro de Tombos</a> a autoria de uma das pias é atribuída a <a>José Victor</a>. Por conta da semelhança entre as duas pias, acredito que ambas tenham sido feitas pelo polímata.`,
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Freguesia era uma denominação utilizada pela <a>Igreja Católica</a> para determinar as áreas de influências da paróquia, determinando um município. A mudança de freguesia do <a>Bação</a> foi quando a paróquia deixou de ser filial da paróquia de <a>Itabira do Campo</a>, em 1883.`,
				longText: `-TODO algo`
			}
		]
	},
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Padre Bernardo se tornou responsável pela <a>Matriz do Bação</a> após o falecimento de <a>Padre Antônio Cândido</a>. Sua gestão era completamente diferente do Padre anterior, ele gostava do silêncio, era contra o <a>Grupo de Seresteiros</a> e a <a>Casa da Banda</a>.`,
			...
			{
				id: "",
				shortText: `Não fazia festas no <a>Adro da Matriz</a> nem gostava que a população permanesse lá.`,
			...
			{
				id: "",
				shortText: `Se incomodava quando o <a>Relógio da torre da Matriz</a> se atrasava, chamando <a>José Victor</a> para consertá-lo sempre ocorria.`,
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Dr. Senna foi um prefeito de <a>Vila Rica</a> na época de <a>José Victor</a>, ele tinha grande interesse nos trabalhos do polímata, chegando até a oferecer uma <a>bolsa</a> para que o inventor continuasse com seus trabalhos.`,
				longText: `-TODO pegar trecho da sintegração`
			},
			{
				id: "",
				shortText: `Dr Senna também foi responsável por mandar água para os <a>chafarizes</a> da cidade, após ganhar a eleição para prefeito contanto com o apoio de <a>Padre Antônio Cândido</a>.`,
		...
		verbatin: [
			{
				...
				longText: `-TODO vídeo sobre josé bastos`
			}
		]
	},
	{
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Havia no <a>Bação</a> um grupo de seresteiros formado por alguns integrantes da <a>Casa da Banda</a>. O grupo acabou porque foi firmemente desestimulado por <a>Padre Bernardo</a>, que tinha uma fala que marcou o imaginário da cidade: "Se você ver um seresteiro, faça de seu violão a sua gravata".`,
				longText: `-TODO imagem`
			}
		]
	},
	...
	},
	{
		...
		verbatin: [
			{
				id: "",
				shortText: `Após a <a>mudança de freguesia</a>, o fluxo de pessoas que ia para o <a>Bação</a> aumentou e isso acarretou no aumento na quantidade de comércios no distrito, principalmente na R. da Pimenta.  Na Rua da Pimenta haviam cerca de 20 pontos de comércios, os comerciantes buscavam mercadorias do <a>Rio de Janeiro</a> pela <a>Estrada de Ferro Central do Brasil</a> e levavam para o <a>Bação</a> mercadorias difíceis de serem achada na região na época, como vinho do porto e seda.  `,
				longText: `No vídeo, <a>Marilene</a> conta sobre uma pesquisa que a realizou com <a>D. Divina</a>, filha de um dos comerciantes da R. da Pimenta, <a>Sr. Benjamin</a>, sobre os tipos de mercadoria que estava chegando ao <a>Bação</a> nessa época. (-TODO colocar vídeo e verificar nome)`
			}
		]
	},
	{
